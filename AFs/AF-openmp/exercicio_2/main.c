...
/*Motivo do erro: estava ocorrendo multiplos acessos a variavel j, que estava declarada antes dos 3 for, o j estava sendo incrementado por todas as threads que chegavam no segundo for, ocorrendo um condição de corrida.
Para resolver o problema, foi criado mais uma região paralela, antes do for que muda o j*/
